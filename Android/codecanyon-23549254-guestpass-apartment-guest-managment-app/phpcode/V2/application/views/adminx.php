...
<div class="content-page">
    ...
    <div class="content">
        <div class="container-fluid ">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="page-title-box ">
                        ...
                        <h4 class="page-title float-left">Estate Admin </h4>

                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">Dashboard</a></li>
                            <li class="breadcrumb-item active">Estate Admin</li>
                        </ol>
            ...
            <!-- MODAL ADD -->
            <form method="post" action="<?php echo base_url(); ?>dashboard/insert1" data-parsley-validate novalidate id="form3" >
                <div class="modal fade" id="Modal_Add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  ...
                  <div class="modal-body custom-modal-text">
                   ...
                   <div class="form-group row">
                    <label for="userName" class="col-md-2 col-form-label">Estate Name<span class="text-danger">*</span></label>
                    <div class="col-md-10">
                   ...
                   <div class="form-group row">
                    <label for="cp_name" class="col-md-2 col-form-label">Contact Person Name<span class="text-danger">*</span></label>
                    <div class="col-md-10">
                        <input type="text" name="cp_name" parsley-trigger="change" required
                        placeholder="Enter Contact Person Name" class="form-control" id="cp_name">
                    </div>
                </div>
                  <div class="form-group row">
                    <label class="col-md-2 col-form-label">Contact Person Mobile No <span class="text-danger">*</span></label>
                    <div class="col-md-10">
                        <input data-parsley-type="number" type="text" name="cp_mobile" id="cp_mobile"
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                    <label for="cp_name" class="col-md-2 col-form-label">City<span class="text-danger">*</span></label>
                    <div class="col-md-10">
                        <input type="text" name="city" parsley-trigger="change" required
                        placeholder="city name" class="form-control" id="city">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label for="sel_pack" class="col-md-2 col-form-label">Select Packages<span class="text-danger">*</span></label>
                    <div class="col-md-10">
                        <select name="pack" class="form-control" id="sel_pack" required >
                            <option >Select Packages</option>
                            <?php

$catData1 = $this->Constant_model->getDataOneColumn('package', 'status', '1');

for ($ct = 0; $ct < count($catData1); ++$ct) {
  $id = $catData1[$ct]->id;
  $name = $catData1[$ct]->name;?>
                               <option><?=$name?></option>
                           <?php }?>
                       </select>
                   </div></div>
                   ...
                   <div class="form-group row">
                    <label for="emailAddress" class="col-md-2 col-form-label">Email address<span class="text-danger">*</span></label>
                    <div class="col-md-10">
                        <input type="email" name="mail" parsley-trigger="change" required
                        placeholder="Enter email" class="form-control" id="emailAddress">
                    </div></div>
                    <div class="form-group row">
                        <label for="pass1" class="col-md-2 col-form-label">Password<span class="text-danger">*</span></label>
                        <div class="col-md-10">
                            <input id="pass1" name="passd" type="Password" placeholder="Enter Password" required
                            class="form-control">
                        </div></div>
                        <div class="form-group row">
                            <label for="passWord2" class="col-md-2 col-form-label">Confirm Password </label>
                            <div class="col-md-10">
                                <input data-parsley-equalto="#pass1" type="password" required
                                placeholder="Enter Confirm Password" class="form-control" id="passWord2">
                            </div></div>
                            <?php
$token =substr(time(),5,5);

?>
<div class="form-group row">
    <label for="pin" class="col-md-2 col-form-label">Pin <span class="text-danger">*</span></label>
    <div class="col-md-10">
        <input type="text" required  class="form-control" id="pin" name="pin" readonly=""
        value="<?=$token?>">
    </div></div>
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-secondary" id="close" onclick="show_product();" data-dismiss="modal">Close</button>
</div>
</div>
</div>
</div>
...
<div class="row" >
    <div class="col-xl-12">
      <div class="col-md-12">
        ...
        <!--  id="mydata" -->
        <table class="container-fluid page-title-box table table-striped" id="datatable-buttons" style="background-color: #fff;">
            <thead>
                <tr>
                     <th>Sr.no.</th>
                    <th>Estate Name</th>
...
<form id="form_update">
    <div class="modal fade" id="Modal_Edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-body custom-modal-text">
        <div class="form-group row">
            <label class="col-md-2 col-form-label">Estate Name</label>
            <div class="col-md-10">
...
<div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-md-10">
      <input type="text" name="pack" id="pack" class="form-control" placeholder="Enter Address here...">
  </div>
</div>
...
<script type="text/javascript">
 ...
 var status_button='<a href="javascript:void(0);" class="btn btn-info btn-sm item_status" data-id="'+data[i].id+'" data-status="'+data[i].status+'">Unsuspend</a>';
                               ...
                               '<td>'+data[i].pack+'</td>'+
                                ...
                                '<div class="btn-group"><a href="javascript:void(0);" class="btn btn-success btn-sm item_edit waves-effect waves-light" data-animation="slip" data-overlaySpeed="100" data-overlayColor="#36404a" data-id="'+data[i].id+'" data-name="'+data[i].name+'" data-mob="'+data[i].mob+'" data-mail="'+data[i].mail+'" data-addr="'+data[i].addr+'" data-pack="'+data[i].pack+'" data-date="'+data[i].date+'"  data-passd="'+data[i].passd+'"data-city="'+data[i].city+'"data-cp_name="'+data[i].cp_name+'"data-cp_mobile="'+data[i].cp_mobile+'">Edit</a>'+' '+
        ...
        $('#show_data').on('click','.item_edit',function(){
            ...
            var cp_mobile        =atob($(this).data('cp_mobile'));
            var cp_name      =atob($(this).data('cp_name'));
            var pack      =atob($(this).data('pack'));
            ...
            $('[name="passd"]').val(passd);
             $('[name="cp_mobile"]').val(cp_mobile);
              $('[name="cp_name"]').val(cp_name);
               $('[name="city"]').val(city);
        });
        ...
        $('#btn_update').on('click',function(){
            ...
            var city        = $('#city').val();
            var passd        = $('#passd').val();
             var cp_mobile        = $('#cp_mobile').val();
              var cp_name       = $('#cp_name').val();
               var pack       = $('#sel_pack').val();

            $.ajax({
                type : "POST",
                url  : "<?php echo site_url('Dashboard/update') ?>",
                dataType : "JSON",
                data : {id:id , user:user, mob:mob, email:email, address:address, city:city, passd:passd,cp_mobile:cp_mobile ,cp_name:cp_name,pack:pack},
                success: function(data){
...
/*
        $("#form1").on("submit",function(e){
            ...
            $.ajax({
              type:"POST",
              url:"<?php echo base_url(); ?>dashboard/insert1",
