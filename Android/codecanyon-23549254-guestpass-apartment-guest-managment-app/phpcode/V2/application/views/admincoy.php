...
<div class="content-page">
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <!-- MODAL ADD -->
            <form method="post" action="<?php echo base_url(); ?>dashboard/insert1" data-parsley-validate novalidate id="form1" >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input data-parsley-type="number" type="text" name="mob"
...
<div class="form-group row">
    ...
    <div class="col-md-10">
      <input type="text" name="pack" id="city" class="form-control" placeholder="Enter Packages here...">
  </div>
</div>
                         <!--    <div class="form-group row">
 ...
 var status_button='<a href="javascript:void(0);" class="btn btn-info btn-sm item_status" data-id="'+data[i].id+'" data-status="'+data[i].status+'">Unsuspend</a>';
        ...
        $('#btn_update').on('click',function(){
            ...
            $.ajax({
                ...
                dataType : "JSON",
                data : {id:id , user:user, mob:mob, email:email, address:address, city:city, passd:passd},
                success: function(data){
