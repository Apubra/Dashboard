      ...
      <div class="row">
        <div class="col-xl-12">
          <!--div class="page-title-box">
            <h4 class="page-title float-left">Estate User</h4>

            <ol class="breadcrumb float-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>Estate_dashboard/">Dashboard</a></li>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
        ...
        function show_product(){
          $.ajax({
            type  : 'ajax',
            url   : '<?php echo base_url() . 'Dashboard/product_data4'; ?>',
            async : false,
            dataType : 'json',
