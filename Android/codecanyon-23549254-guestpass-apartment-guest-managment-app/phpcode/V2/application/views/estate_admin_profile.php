        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xs-12 col-lg-12 col-xl-8">
                    <div class="card-box" style="margin-top: 30px; height:440px">
                    ...
                    <?php
                                $this->db->select('*');
                                $this->db->where('estate_id',$this->session->userdata('user_id'));

                                $query1 = $this->db->get('transaction');
                                foreach ($query1->result_array() as $row1) {
                                $estate_id = $row1['estate_id']; 
                                $datee = $row1['date']; 
                                $payment_mod = $row1['payment_mod']; 
                                $descri = $row1['descri'];
                                $amt = $row1['amt'];
                                $status = $row1['status'];
                                }
                    ...
                    <div class="card-box">
                        ...
                        <h4 class="header-title m-t-0 m-b-30">Transcations</h4>
                            ...
                            <table class="table table-bordered mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <th class="text-muted"><?php echo $user_id; ?></th>
                                        <td><?php echo $datee; ?></td>
                                        <td><?php echo $payment_mod; ?></td>
                                        <td><?php echo $descri; ?></td>
                                        <td><?php echo $amt; ?></td>
                                        
                                        <td><span class="label label-success"><?php if($status=='1'){echo 'active';}else{echo 'inactive';} ?> </span></td>
                                    </tr>
                                    <tr>
           ...
           <?php  
            $this->db->where('estate_id',$this->session->userdata('user_id'));
           $x=$this->db->get('transaction')->result();
                foreach($x as $row)  
                {  
           ?>  
                <tr>  
                     <td><?php echo $row->estate_id; ?></td>  
                     <td><?php echo $row->date; ?></td>  
                     <td><?php echo $row->payment_mod; ?></td>  
                     <td><?php echo $row->descri; ?></td>
                     <td><?php echo $row->amt; ?></td> 
                     <td><?php if($row->status =='1'){echo 'paid';}else{echo 'unpaid';} ?></td> 
...
?>
              ...
              <form id="form_update1" action="<?= base_url()?>Profile/update4" method="post">
                  ...
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      <div class="modal-header" style="background-color: #64b0f2;">
                        <h5 class="modal-title" id="exampleModalLabel" style="color: white">Edit Estate Profile</h5>
                      ...
                      <div class="modal-body">
                          ...
                          <label class="col-md-2 col-form-label">Estate SignUp Date</label>
                          <div class="col-md-10">
                            <input type="text" name="date" id="date" value="<?php echo $date; ?>" class="form-control" placeholder="Enter Package Name" required="">
                          </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-10">
                            <input type="text" name="descri" id="descri" value="<?php echo $descri; ?>" class="form-control" placeholder="Enter Package Expirery Date..." required="">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-10">
                            <input type="text" name="status" id="status" value="<?php echo $status; ?>" class="form-control" placeholder="Enter Package Expirery Date..." required="">
                          </div>
                        </div>
